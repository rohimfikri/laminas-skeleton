...
class InboxModel{
    ...
    public function getUnreadInboxByUidByLayoutByModule($uid, $layout, $module,$fromcache = true){
        if($uid==="" || $uid===null)
            return [];
        ...
        if ($this->dataCache->hasItem($key) && $fromcache){
          ...
          return json_decode($data,true);
            ...
            $sql = "CALL lam_sys.get_userunreadinbox_byuid_layout_module(:uid,:theme,:module)";
            // die($sql);
